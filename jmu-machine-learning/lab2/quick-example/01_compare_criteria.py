...
plt.title('Decision Tree (Gini Index)', fontsize=20, fontweight='bold', pad=30)
plt.tight_layout()
plt.savefig('output/figures/tree_gini.png', dpi=200, bbox_inches='tight')
plt.close()
...
plot_tree(clf_entropy, feature_names=feature_names, class_names=target_names,
          filled=True, rounded=True, fontsize=11, ax=ax,
          proportion=True, precision=2, impurity=True)
plt.title('Decision Tree (Information Gain / Entropy)', fontsize=20, fontweight='bold', pad=30)
plt.tight_layout()
plt.savefig('output/figures/tree_entropy.png', dpi=200, bbox_inches='tight')
plt.close()
